...
- Risk Lab provides a guided three-case tour with a selectable outcome spectrum and Previous/Next controls. It can open only view-only demo results; it never calculates a verdict, enables payment handoff, or exposes report/share/recovery actions for seeded data.
