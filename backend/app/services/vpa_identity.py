...
PROTECTED_BRAND_TOKENS: frozenset[str] = frozenset(
    {
        "sbi", "statebank", "hdfc", "icici", "axis", "kotak", "pnb", "boi",
        "bob", "baroda", "canara", "union", "idfc", "yesbank", "indusind",
        "rbl", "federal", "npci", "bhim", "rbi", "paytm", "phonepe",
        "gpay", "googlepay", "amazonpay", "bharatpe", "razorpay", "irctc",
        "lic", "epfo", "uidai", "aadhaar", "incometax", "gst", "customs",
        "police", "cbi", "cybercrime", "court", "army", "airtel", "jio",
        "vodafone", "bsnl", "tneb", "electricity", "postoffice",
    }
)
...
PRETEXT_TOKENS: frozenset[str] = frozenset(
    {
        "kyc", "kycupdate", "verify", "verified", "verification", "validate",
        "refund", "refunds", "reward", "rewards", "prize", "lottery", "lucky",
        "winner", "cashback", "bonus", "gift", "offer", "free", "claim",
        "support", "helpdesk", "helpline", "customercare", "care", "service",
        "official", "authorised", "authorized", "secure", "security", "safety",
        "update", "unblock", "block", "reactivate", "penalty", "fine", "dues",
        "urgent", "emergency", "insurance", "policy", "loan", "approval",
        "trading", "investment", "profit", "task", "parttime", "workfromhome",
    }
)
